...
We now consider an example of loading in and creating the IntCal09 calibration curve, but please note that the radiocarbon calibration curve website has been down for several months, so this may not run at present:
