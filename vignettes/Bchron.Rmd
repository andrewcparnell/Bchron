...
Bchron will run in Windows, Mac OS X or Linux. To install Bchron you first need to install [R](https://www.r-project.org). I would also recommend installing [Rstudio](https://rstudio.com) as a nice desktop environment for using R. Once in R you can type:
