...
As an example, consider installing the intcal09 calibration curve, traditionally available from http://www.radiocarbon.org/IntCal09%20files/intcal09.14c. We can run the following code:
