...
You will find Bchron far easier to use if you know some basics on how to use R. I recommend the book by Norman Matloff [amazon.co.uk link](https://www.amazon.co.uk/The-Art-Programming-Statistical-Software/dp/1593273843), or the online courses by [Pluralsight](https://www.pluralsight.com)
...
Bchron will run in Windows, Mac OS X or Linux. To install Bchron you first need to install [R](https://www.r-project.org). I would also recommend installing [Rstudio](https://www.rstudio.com) as a nice desktop environment for using R. Once in R you can type:
...
## I would like to plot some extra dates on my chronology

Suppose we created the standard Glendalough chronology
